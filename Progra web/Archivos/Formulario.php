    ...
    <script>
        ...
        function validacion() {
            ...
            if (validarNombre() && validarCorreo() && validarPass() && validarRol() && validarArchivo()) {
                ...
                $("#errorMessage").html("Hay campos vacios... <br>inserte datos para continuar.");
        ...
        <div name="registro" id="registro">
            <form name="myform" id="myform" autocomplete="off" enctype="multipart/form-data" method="POST">
                <div id="regBox">
                    ...
                    <input placeholder="Contraseña" autocomplete="off" type="password" name="pass" id="pass" required /><br><br>
                    ...
                    <div>
                        <input onclick="validacion(); return false;" class="btn btn-success" type="submit"
                            value="Crear administrador" name="submit" id="submit"><br>
                    </div>
